  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <h1 className="text-3xl md:text-5xl font-serif text-neutral-900 mb-8">
          {page.title}
        </h1>
            ...
            <div className="text-neutral-700 leading-relaxed space-y-4">
              {page.content.split("\n").map((paragraph: string, index: number) => {
                ...
                if (trimmed.startsWith("## ")) {
                  return <h2 key={index} className="text-2xl font-serif text-neutral-900 mt-8 mb-4">{trimmed.replace("## ", "")}</h2>;
                }
                if (trimmed.startsWith("### ")) {
                  return <h3 key={index} className="text-xl font-serif text-neutral-900 mt-6 mb-3">{trimmed.replace("### ", "")}</h3>;
                }
