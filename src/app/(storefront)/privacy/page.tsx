  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-sm text-neutral-500 mb-10">Last updated: January 2025</p>

        <div className="space-y-8 text-sm text-neutral-700 leading-relaxed">
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">3. Information Sharing</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">4. Data Security</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">5. Cookies</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">6. Your Rights</h2>
            <p>You have the right to access, correct, or delete your personal information. You may also opt out of marketing communications at any time. To exercise these rights, contact us at <span className="text-[#C9A84C]">hello@ratnagiri.com</span>.</p>
          </section>

          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">7. Contact</h2>
            <p>For any questions about this privacy policy, please contact us at <span className="text-[#C9A84C]">hello@ratnagiri.com</span>.</p>
          </section>
        </div>
      </div>
    </main>
