    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-sm text-neutral-700 leading-relaxed">
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">2. Products & Pricing</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">3. Orders & Payment</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">4. Shipping & Delivery</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">5. Returns & Refunds</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">6. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">7. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">8. Governing Law</h2>
          ...
          <section>
            <h2 className="text-lg font-serif text-neutral-900 mb-3">9. Contact</h2>
            <p>For questions about these terms, contact us at <span className="text-[#C9A84C]">hello@ratnagiri.com</span>.</p>
          </section>
        </div>
      </div>
    </main>
