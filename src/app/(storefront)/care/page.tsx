    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-10 text-neutral-700">
          <section>
            <h2 className="text-xl font-serif text-neutral-900 mb-4">General Care Tips</h2>
          ...
          <section>
            <h2 className="text-xl font-serif text-neutral-900 mb-4">Temple Jewelry</h2>
          ...
          <section>
            <h2 className="text-xl font-serif text-neutral-900 mb-4">Kundan & Jadau</h2>
            <p className="text-sm leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-xl font-serif text-neutral-900 mb-4">Silver Jewelry</h2>
            <p className="text-sm leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-xl font-serif text-neutral-900 mb-4">Gemstone Jewelry</h2>
            <p className="text-sm leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-xl font-serif text-neutral-900 mb-4">Professional Cleaning</h2>
            <p className="text-sm leading-relaxed">
              For annual maintenance or deep cleaning, we recommend professional jewelry cleaning. Contact us at{" "}
              <span className="text-[#C9A84C]">hello@ratnagiri.com</span> to schedule a professional cleaning for your Ratnagiri pieces.
            </p>
          </section>
        </div>
      </div>
